...
const Features = () => {
    ...
    return (
        <div id='features' className="flex flex-col items-center justify-center py-20 px-6 md:px-12 lg:px-24 bg-white">
        ...
        <Titles content={{ title: "Build Your Resume", description: "Explore the powerful features that make our product stand out." }}></Titles>
